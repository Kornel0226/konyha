...
const UserRecipes: FC<{ recipes: Recipe[], deleteRecipe: (recipe_id: number) => void }> = ({ recipes, deleteRecipe }) => {
    ...
    return <div className=" bg-orange-300 min-h-[100vh] p-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
            ...
            <button onClick={() => navigate("új")} className="w-[200px] h-[304px] rounded-xl bg-orange-600 flex flex-col text-center items-center hover:transform hover:scale-110 transition-transform duration-300 ease-in-out" ><img src={plus} alt="add" />
                <p className="text-center text-4xl font-semibold">Új recept</p></button>
        </div>
